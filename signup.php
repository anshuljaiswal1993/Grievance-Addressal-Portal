<?php
  ...
  if(empty($_POST)===false){
	$nitcId =  mysql_real_escape_string($_POST['nitcId']);
    ...
    if(empty($name) || empty($email) ||empty($password)){
      ...
      $message = "It's not a valid email address";
		...
		{
      mysql_query("INSERT INTO `user` VALUES ('$nitcId','$name','$email','$password',NOW())"); 
      $message = "Your account has been Registerd";
		}
		else{
			echo'<script> alert("Emailid is already registered");</script>';
			header('signup.php');
		}
      }
	}
	...
	{
		echo'<script> alert("Please reg. with nitc mail");</script>';
	}
  }
?>
<!DOCTYPE html>
    ...
    <div class="cover user text-center">
      ...
      <div class="padd">
        <div class="col-lg-12 text-center">
			  ...
			  <input type="text" name="nitcId" placeholder="RollNo/EmpId">
                <br><br>
